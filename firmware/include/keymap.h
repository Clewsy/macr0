...
extern const char KEYMAP[NUM_ROWS][NUM_COLS];
		...
		#define HID_MEDIACONTROLLER_SC_PLAY				0x66
		#define HID_MEDIACONTROLLER_SC_PAUSE				0x67
		#define HID_MEDIACONTROLLER_SC_FAST_FORWARD			0x68
		#define HID_MEDIACONTROLLER_SC_REWIND				0x69
		#define HID_MEDIACONTROLLER_SC_NEXT				0x6A
		#define HID_MEDIACONTROLLER_SC_PREVIOUS				0x6B
		#define HID_MEDIACONTROLLER_SC_STOP				0x6C
		#define HID_MEDIACONTROLLER_SC_TOGGLE				0x6D
		#define HID_MEDIACONTROLLER_SC_MUTE				0x6E
		#define HID_MEDIACONTROLLER_SC_VOLUME_UP			0x6F
		#define HID_MEDIACONTROLLER_SC_VOLUME_DOWN			0x70
