...
// clewsy: commented for now, may remove completely once I decide how to handle LED control.
...
// Type Defines:
// Type define for a Media Control HID report. This report contains the bits to match the usages defined in the HID report of the device.
// When set to a true value, the relevant media controls on the host will be triggered.
